...
class TestHelper(unittest.TestCase):
    def setUp(self) -> None:
        ...
        try:
            ...
            pass
        scheme = 'https'
        ors_path = 'service.enterprise.informatik.uni-leipzig.de/de4l-privacy/open-route'
        ors_profile = 'driving-car'
        nominatim_path = 'service.enterprise.informatik.uni-leipzig.de/de4l-privacy/nominatim'
